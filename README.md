...
業務システムの開発・改修、保守改善、  
AIを活用した業務・開発改善に取り組むソフトウェアエンジニアです。

**Evisu Works** として、  
業務システム開発・改修 / 業務改善・DX支援を行っています。
...
KiroのHooks / Steeringを利用した、静的解析・AIコードレビューの開発ワークフロー。

## Products

### [SoloOps Dock](https://soloopsdock.com/)

Solo SaaS運営者向けの運用支援プロダクト。  
Changelog、Announcement Bar、Maintenance Notice、Status Pageを提供。
